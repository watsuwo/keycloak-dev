...
acceptance_tests:                    # この spec を verify するテスト
  - keycloak/providers/01-email-domain-allowlist/src/test/
...
| [writing-keycloak-spi-pattern](../../.claude/skills/writing-keycloak-spi-pattern/SKILL.md) | 新 SPI パターン実装 (0N-name dir、Maven module、META-INF/services、フロー検出ヘルパー等の規約) |
