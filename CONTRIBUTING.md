...
```
fix(keycloak/providers/01-email-domain-allowlist): support Direct Grant 500 error
...
## 関連
- Refs: #issue番号
- Related to: docs/specs/patterns/0N-...
...
1. `keycloak/providers/0N-<pattern-name>/` ディレクトリを既存パターンから複製
...
8. `docs/specs/patterns/0N-<name>.md` に **レシピ** (when to use / config / 派生方法 / 既知の限界 / 過去適用案件) を書く
...
4. `docs/specs/patterns/0N-...` を必要に応じて更新
5. PR 作成
...
| 変更タイプ | 更新が必要な docs |
| --- | --- |
| 新パターン追加 | `keycloak/providers/CLAUDE.md` (一覧)、`docs/specs/patterns/0N-...md` (レシピ)、`README.md` (ディレクトリ構成) |
